...
#my_string = "1 a 2 b";
#my_string = "||We're so close to hitting our goal of 50 Twitter donations to celebrate my #CPAC2015 Straw Poll victory! Chip-in >> https://secure.randpac.com/?sr=cpacwinner ||";
...
article_word_graph = Graph(startNodes=[article_word_node], graphID="Long Article Word");
...
# Prepositions
preposition_word_node = Graph(graphID="Preposition Word",matches=preposition_word);

preposition_word_graph = Graph(startNodes=[preposition_word_node], graphID="Long Preposition Word");
...
pronoun_word_graph = Graph(startNodes=[pronoun_word_node],graphID="Long Pronoun Word");
...
word_word_node = Graph(graphID="Word");		# This has no data, we only check the id
word_word_node.nexts.append(None);
word_word_graph = Graph(startNodes=[word_word_node], graphID="Word");

long_number_number_node = Graph(graphID="Long Number");		# This has no data, we only check the id
long_number_number_node.nexts.append(None);
long_number_number_graph = Graph(startNodes=[long_number_number_node],graphID="Long Number");
