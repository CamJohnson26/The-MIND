import copy
import json
from mind_registry_networkx import Registry
import networkx as nx
# import matplotlib.pyplot as plt

# A graph is a collection of Nodes that are
# arranged as a tree. The lowest node of a graph will match some value


class Graph:

    nx_graph = None
    matching_primitive = None

    def __init__(self, matching_primitive):
        self.nx_graph = nx.DiGraph()
        self.matching_primitive = matching_primitive
    ...
    # Boolean: Does the input object match the current graph?
    def matches(self, char_obj):
        return self.matching_primitive == char_obj
...
###############################################################################
    ...
    def matches(self, char_obj):
        ...
        if isinstance(self.matching_object, Graph):
            ...
            # If our node matches nothing and the
            # input shares its id, they match
